...
#
MODE = 'site'; #'sim" for simulator, 'site' for test site
    ...
    def __init__(self):
        ...
        if MODE == 'site':
           detect_model_name = 'traffic_light_inference_graph_site'
            ...
            detect_model_name = 'traffic_light_inference_graph_sim'
...
#                        3: {'id': 3, 'name': 'Yellow'}}  
        ...
        with self.detection_graph.as_default():
              ...
              '''
              cls is the list of top 100 classification results (based on confidence)
              
              [3.0, 3.0, 1.0, 3.0, 1.0, 1.0, 3.0, 3.0, 3.0, 2.0, 3.0, 3.0, 1.0, 
              1.0, 1.0, 3.0, 3.0, 3.0, 3.0, 1.0, 1.0, 2.0, 2.0, 1.0, 1.0, 2.0, 
              3.0, 3.0, 3.0, 2.0, 1.0, 3.0, 3.0, 1.0, 3.0, 3.0, 2.0, 1.0, 3.0, 
              1.0, 2.0, 3.0, 2.0, 3.0, 1.0, 3.0, 1.0, 2.0, 3.0, 3.0, 1.0, 3.0, 
              3.0, 1.0, 3.0, 1.0, 2.0, 3.0, 1.0, 1.0, 2.0, 1.0, 2.0, 3.0, 2.0, 
              2.0, 2.0, 3.0, 1.0, 3.0, 1.0, 2.0, 1.0, 3.0, 3.0, 1.0, 3.0, 3.0, 
              2.0, 1.0, 2.0, 2.0, 1.0, 3.0, 3.0, 1.0, 3.0, 1.0, 2.0, 2.0, 2.0, 
              2.0, 1.0, 1.0, 1.0, 3.0, 1.0, 3.0, 3.0, 2.0]
              '''
...
if __name__ == '__main__':
        ...
        wrong_color=[];
        failed_img_names =[];
        TEST_IMAGE_PATHS= glob(os.path.join('stress_test/Nothing', '*.*'))
        ...
        for i, image_path in enumerate(TEST_IMAGES):
            ...
            if (tl_cls.signal_status == "Unknown"): 
                   no_correct_cls +=1
        ...
        '''    
        plt.hist(det_conf, facecolor ='yellow')
        plt.title('Yellow, Batch 4, Acc='+str(acc)[0:5])
